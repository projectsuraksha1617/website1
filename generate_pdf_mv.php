...
$query="insert into vehicletheft4(tid,Case_Type,Name,Regno,Model,Color,Severity) values('".$tid."','".$type."','".$name."','".$reg."','".$model."','".$color."','".$severity."')";
			...
			<div class="col-md-8">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form class="form-horizontal" action="insert_pdf_mv.php" method="post">
							<fieldset>
								<!-- Name input-->
								<div class="form-group">
									<?php
									...
									$res=mysqli_query($mysql,"select tid from vehicletheft4 where tid='$tid'");
