...
$query="insert into accident4(tid,Case_type,Name,Mobile,Acc_Location,Severity) values('".$tid."','".$type."','".$name."','".$mob."','".$loc."','".$severity."')";
			...
			<div class="col-md-8">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form class="form-horizontal" action="insert_pdf_acc.php" method="post">
							<fieldset>
								<!-- Name input-->
								<div class="form-group">
									<?php
									...
									$res=mysqli_query($mysql,"select tid from accident4 where tid='$tid'");
