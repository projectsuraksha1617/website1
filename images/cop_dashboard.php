...
width: 1020px;
height:550px;
  background: url(images/digital-india.jpg) repeat;
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li class="active"><a href="cop_dashboard.php"><svg class="glyph stroked dashboard-dial"></svg><i class="fa fa-home" aria-hidden="true"></i><strong> Dashboard</strong></a></li>
			...
			<li><a href="casenoti.php"><svg class="glyph stroked table"></svg><i class="fa fa-bell" aria-hidden="true"></i><strong> Case Notification</strong></a></li>
			<li ><a href="pending.html"><svg class="glyph stroked pencil"></svg><i class="fa fa-list-alt" aria-hidden="true"></i><strong> Pending Cases</strong></a></li>
			<li><a href="panels.html"><svg class="glyph stroked app-window"></svg><i class="fa fa-taxi" aria-hidden="true"></i><strong> Active Case</strong></a></li>
			<li><a href="icons.html"><svg class="glyph stroked star"></svg><i class="fa fa-check-square-o" aria-hidden="true"></i><strong> Completed Cases</strong></a></li>
