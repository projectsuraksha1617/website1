...
$query="insert into lostmobile(date,tid,Case_Type,Mobile_Name,Mobile_Model,IMEI,Purchase_Date,Mobile_Numb,Email,Description,Bill,Severity) values('".$d."','".$rand."','".$type."','".$name."','".$mod."','".$imei."','".$date."','".$mob."',,'".$email."','".$des."','".$bill."','".$severity."')";
$res=mysqli_query($mysql,$query);
$query1="insert into lostmobile_history(date,tid,Case_Type,Mobile_Name,Mobile_Model,IMEI,Purchase_Date,Mobile_Numb,Email,Description,Bill,Severity) values('".$d."','".$rand."','".$type."','".$name."','".$mod."','".$imei."','".$date."','".$mob."','".$email."','".$des."','".$bill."','".$severity."')";
