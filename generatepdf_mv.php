...
$result=mysqli_query($mysql,"select date,tid,Case_Type,Name from vehicletheft_history where tid='$tid'");
...
$result1=mysqli_query($mysql,"select Name,Status,Mobile,Details from pdf_mv where tid='$tid'");
